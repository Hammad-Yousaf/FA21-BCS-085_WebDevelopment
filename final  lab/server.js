...
const searchRoutes = require('./routes/api/cars');
...
app.get('/', async function(req, res, next) {
  ...
  try {
    ...
    return res.render('homepage', { featuredProducts });
  } catch (err) {
...
app.get('/products/:id', async (req, res) => {
  try {
    ...
    res.render('featured-products', { product });
  } catch (error) {
...
app.get('/visited-prod', async (req, res) => {
  try {
